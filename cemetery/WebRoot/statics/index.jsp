...
<html>
  <head>
	...
	<meta http-equiv="Content-Type" content="text/statics; charset=UTF-8">
...
function initialise() {
	...
	l2ID = theMenu.addEntry(-1, "Folder", "上海公墓管理系统", "main.jsp", "上海公墓管理系统");
	
	L01 = theMenu.addChild(l2ID, "Folder", "墓区管理", "", "墓区管理...");
	L0101 = theMenu.addChild(L01, "Document", "墓区设置", "list.html", "墓区设置...");
	L0102 = theMenu.addChild(L01, "Document", "墓区浏览", "dev.html", "墓区浏览...");
	L0103 = theMenu.addChild(L01, "Document", "墓区查询", "list.html", "墓区设置...");
	L0104 = theMenu.addChild(L01, "Document", "墓区修改", "dev.html", "墓区浏览...");

	
	L02 = theMenu.addChild(l2ID, "Folder", "墓穴管理", "", "墓穴管理...");
	L0201 = theMenu.addChild(L02, "Document", "墓穴设置", "~cust/cust/list.html", "墓穴设置...");
	L0201 = theMenu.addChild(L02, "Document", "墓穴浏览", "~cust/lost/list.html", "墓穴浏览...");
	L0201 = theMenu.addChild(L02, "Document", "墓穴查询", "~cust/cust/list.html", "墓穴查询...");
	L0201 = theMenu.addChild(L02, "Document", "使用情况", "~cust/lost/list.html", "使用情况...");	

	L03 = theMenu.addChild(l2ID, "Folder", "系统设置", "", "系统设置...");
	L0301 = theMenu.addChild(L03, "Document", "瓷像设置", "~cust/service/add.html", "瓷像设置...");
	L0302 = theMenu.addChild(L03, "Document", "地区设置", "~cust/service/dispatch.html", "地区设置...");
	L0303 = theMenu.addChild(L03, "Document", "墓穴类别设置", "~cust/service/deal.html", "墓穴类别设置...");
	L0304 = theMenu.addChild(L03, "Document", "地址电话设置", "~cust/service/feedback.html", "地址电话设置...");
	L0305 = theMenu.addChild(L03, "Document", "用户权限设置", "~cust/service/arch.html", "用户权限设置...");
	
	
	L04 = theMenu.addChild(l2ID, "Folder", "营销管理", "", "营销管理...");
	L0401 = theMenu.addChild(L04, "Document", "施工单输入", "~rept/contr.html",  "施工单输入...");
	L0402 = theMenu.addChild(L04, "Document", "施工单修改", "~rept/cons.html", "施工单修改...");
	L0403 = theMenu.addChild(L04, "Document", "施工单查询", "~rept/ser.html", "施工单查询...");
	L0404 = theMenu.addChild(L04, "Document", "施工单浏览", "~rept/lost.html", "施工单浏览...");
	L0405 = theMenu.addChild(L04, "Document", "墓穴查询", "", "墓穴查询...");
	L0406 = theMenu.addChild(L04, "Document", "装修及其它", "", "装修及其它...");
	L0407 = theMenu.addChild(L04, "Document", "施工进度管理", "", "施工进度管理...");
	L0408 = theMenu.addChild(L04, "Document", "施工进度查询", "", "施工进度查询...");
	L0409 = theMenu.addChild(L04, "Document", "打印合同及证书", "", "打印合同及证书...");
	
	L05 = theMenu.addChild(l2ID, "Folder", "维护费管理", "", "维护费管理...");
	L0501 = theMenu.addChild(L05, "Document", "续交维护费", "../html/dict.html", "续交维护费...");
	L0502 = theMenu.addChild(L05, "Document", "维护费修改", "../html/product.html", "维护费修改...");
	L0503 = theMenu.addChild(L05, "Document", "维护费查询", "../html/storage.html", "维护费查询...");
	L0504 = theMenu.addChild(L05, "Document", "维护费打印", "", "维护费打印...");
	
	L06 = theMenu.addChild(l2ID, "Folder", "定墓管理", "", "定墓管理...");
	L0601 = theMenu.addChild(L06, "Document", "定墓输入", "", "定墓输入...");
	L0602 = theMenu.addChild(L06, "Document", "定墓查询", "", "定墓查询...");
	L0603 = theMenu.addChild(L06, "Document", "定墓取消", "", "定墓取消...");
	L0604 = theMenu.addChild(L06, "Document", "定墓浏览", "", "定墓浏览...");
	
	L07 = theMenu.addChild(l2ID, "Folder", "客户查询", "", "客户查询...");
	L0701 = theMenu.addChild(L07, "Document", "施工单编号", "", "施工单编号...");
	L0702 = theMenu.addChild(L07, "Document", "墓穴位置", "", "墓穴位置...");
	L0703 = theMenu.addChild(L07, "Document", "申请人姓名", "", "申请人姓名...");
	L0704 = theMenu.addChild(L07, "Document", "使用人姓名", "", "使用人姓名...");
	L0705 = theMenu.addChild(L07, "Document", "联系电话", "", "联系电话...");
	L0706 = theMenu.addChild(L07, "Document", "联系地址", "", "联系地址...");
	
	L08 = theMenu.addChild(l2ID, "Folder", "财务管理", "", "财务管理...");
	L0801 = theMenu.addChild(L08, "Document", "财务日报表", "", "财务日报表...");
	L0802 = theMenu.addChild(L08, "Document", "财务月报表", "", "财务月报表...");
	
	L09 = theMenu.addChild(l2ID, "Folder", "数据管理", "", "数据管理...");
	L0901 = theMenu.addChild(L09, "Document", "数据备份", "", "数据备份...");
	L0902 = theMenu.addChild(L09, "Document", "数据恢复", "", "数据恢复...");
